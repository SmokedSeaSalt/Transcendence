...
export default function TermsOfService() {
	return (
		...
		>
			<h1 className="text-text-colored font-bold text-4xl mb-1" id="tos-heading">Terms of Service</h1>

			<p>Last updated: 2026-07-08</p>

			<section aria-labelledby="intro">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="intro">Introduction</h2>
				<p>
			...
			<section aria-labelledby="accounts">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="accounts">Accounts & Authentication</h2>
				<p>
			...
			<section aria-labelledby="user-conduct">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="user-conduct">User Conduct</h2>
				<ul>
			...
			<section aria-labelledby="multiplayer">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="multiplayer">Multiplayer & Matches</h2>
				<p>
			...
			<section aria-labelledby="content">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="content">Content & Intellectual Property</h2>
				<p>
			...
			<section aria-labelledby="privacy">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="privacy">Privacy</h2>
				<p>
					<span>We collect account and gameplay data needed to run the Service. See
					our See our </span>
					<Link to="/privacy-policy">Privacy Policy</Link>
					<span> for details on what is collected, how it is used, and your rights.</span>
				</p>
			</section>

			<section aria-labelledby="disclaimer">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="disclaimer">Disclaimer & Liability</h2>
				<p>
			...
			<section aria-labelledby="termination">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="termination">Termination</h2>
				<p>
					<span>We may suspend or terminate access for violations of these Terms or
			...
			<section aria-labelledby="changes">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="changes">Changes to Terms</h2>
				<p>
