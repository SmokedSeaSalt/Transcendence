...
export default function PrivacyPolicy() {
	return (
		...
		>
			<h1 className="text-text-colored font-bold text-4xl mb-1" id="pp-heading">Privacy Policy</h1>
			...
			<section aria-labelledby="data-collected">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="data-collected">Information We Collect</h2>
				<ul>
					<li>
			...
			<section aria-labelledby="use">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="use">How We Use Information</h2>
				<ul>
					<li>
			...
			<section aria-labelledby="sharing">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="sharing">Sharing & Third Parties</h2>
				<p>
			...
			<section aria-labelledby="cookies">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="cookies">Cookies & Local Storage</h2>
				<p>
			...
			<section aria-labelledby="security">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="security">Security</h2>
				<p>
			...
			<section aria-labelledby="retention">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="retention">Data Retention</h2>
				<p>
			...
			<section aria-labelledby="rights">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="rights">Your Rights</h2>
				<p>
			...
			<section aria-labelledby="changes">
				<h2 className="text-text-colored font-bold text-2xl mb-1" id="changes">Changes to This Policy</h2>
				<p>
