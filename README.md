...
| :------ | :----- | :------------- | :------------ | :---------- |
| **WEB** Use a framework for both the frontend and backend. | 2 | We are using React for the frontend and ExpressJS for the backend. | Justification | All team members have contributed/worked with both frameworks. |
